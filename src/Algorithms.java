...
public class Algorithms {
    ...
    public static void exchangeMutation(final int index, final int exchanges){
        ...
        while(!done)
        {
            ...
            thisChromo.setDataTask1(gene1,thisChromo.DataTask1[gene2]);
    ...
    private void printBestSolution(){
        ...
        for(int i =0; i<DestinationTask1; i++){
            System.out.println(" Destination " + i + " : " + winner1.DataTask1[i] );
        }
        System.out.println("Task 1 Cost : " + winner1.FactorialCost[1]);
        System.out.println("Task 2 result :");
        for(int i =0; i<DestinationTask2; i++){
            System.out.println(" Destination " + i + " : " + winner2.DataTask2[i] );
        }
        System.out.println("Task 2 Cost : " + winner2.FactorialCost[2]);
